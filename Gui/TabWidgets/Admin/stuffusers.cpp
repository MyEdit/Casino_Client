...
void StuffUsers::openCreatRecotd()
{
    ...
    connect(workingWithStuffUsers.get(), &W_StuffUser::update, pagination.get(), &Pagination::start);
...
void StuffUsers::visibleEditing(bool flag)
{
...
void StuffUsers::visibleFiltr(bool flag)
{
