...
public:
    ...
    void setupUi(QWidget *ActiveTables)
    {
        ...
        checkBox_Filtr = new QCheckBox(ActiveTables);
...
"}"));
    ...
    void retranslateUi(QWidget *ActiveTables)
    {
        ...
        checkBox_Filtr->setText(QApplication::translate("ActiveTables", "\320\244\320\270\320\273\321\214\321\202\321\200\320\260\321\206\320\270\321\217", nullptr));
