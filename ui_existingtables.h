...
public:
    ...
    void setupUi(QWidget *ExistingTables)
    {
        ...
        label = new QLabel(ExistingTables);
        ...
        searchColumn = new QComboBox(ExistingTables);
        ...
        searchText = new QLineEdit(ExistingTables);
        searchText->setObjectName(QString::fromUtf8("searchText"));
        searchText->setFont(font);

        horizontalLayout_9->addWidget(searchText);

        checkBox = new QCheckBox(ExistingTables);
        checkBox->setObjectName(QString::fromUtf8("checkBox"));
        checkBox->setFont(font);

        horizontalLayout_9->addWidget(checkBox);

        pushButton_search = new QPushButton(ExistingTables);
...
"}"));
        ...
        clearSearch = new QPushButton(ExistingTables);
...
"}"));
        ...
        label_3 = new QLabel(ExistingTables);
        label_3->setObjectName(QString::fromUtf8("label_3"));
        label_3->setFont(font);

        horizontalLayout_8->addWidget(label_3);

        sortingColumn = new QComboBox(ExistingTables);
        ...
        label_2 = new QLabel(ExistingTables);
        ...
        typeSorting = new QComboBox(ExistingTables);
        ...
        sorting = new QCheckBox(ExistingTables);
        ...
        moreDetailed = new QPushButton(ExistingTables);
...
"}"));
        ...
        addTable = new QPushButton(ExistingTables);
...
"}"));
        ...
        label_4 = new QLabel(ExistingTables);
        label_4->setObjectName(QString::fromUtf8("label_4"));
        label_4->setFont(font);

        horizontalLayout_6->addWidget(label_4);

        labelCurrentPage = new QLabel(ExistingTables);
        ...
        labelMaxPage = new QLabel(ExistingTables);
        ...
        prevButton = new QPushButton(ExistingTables);
...
"}"));
        ...
        label_6 = new QLabel(ExistingTables);
        label_6->setObjectName(QString::fromUtf8("label_6"));
        label_6->setFont(font);

        horizontalLayout_10->addWidget(label_6);

        pageNumberToNavigate = new QLineEdit(ExistingTables);
        ...
        nextButton = new QPushButton(ExistingTables);
...
"}"));
    ...
    void retranslateUi(QWidget *ExistingTables)
    {
        ...
        label->setText(QApplication::translate("ExistingTables", "\320\237\320\276\320\270\321\201\320\272:", nullptr));
        checkBox->setText(QApplication::translate("ExistingTables", "\320\242\320\276\321\207\320\275\320\276\320\265 \n"
"\321\201\320\276\320\262\320\277\320\260\320\264\320\265\320\275\320\270\320\265", nullptr));
        ...
        label_3->setText(QApplication::translate("ExistingTables", "\320\241\320\276\321\200\321\202\320\270\321\200\320\276\320\262\320\260\321\202\321\214 \321\201\321\202\320\276\320\273\320\261\320\265\321\206:", nullptr));
        label_2->setText(QApplication::translate("ExistingTables", "\320\277\320\276", nullptr));
        typeSorting->setItemText(0, QApplication::translate("ExistingTables", "\320\237\320\276 \320\262\320\276\320\267\321\200\320\260\321\201\321\202\320\260\320\275\320\270\321\216", nullptr));
        typeSorting->setItemText(1, QApplication::translate("ExistingTables", "\320\237\320\276 \321\203\320\261\321\213\320\262\320\260\320\275\320\270\321\216", nullptr));

        sorting->setText(QApplication::translate("ExistingTables", "\320\241\320\276\321\200\321\202\320\270\321\200\320\276\320\262\320\260\321\202\321\214", nullptr));
        moreDetailed->setText(QApplication::translate("ExistingTables", "\320\237\320\276\320\264\321\200\320\276\320\261\320\275\320\265\320\265", nullptr));
        addTable->setText(QApplication::translate("ExistingTables", "\320\224\320\276\320\261\320\260\320\262\320\270\321\202\321\214", nullptr));
        label_4->setText(QApplication::translate("ExistingTables", "\320\242\320\265\320\272\321\203\321\211\320\260\321\217 \321\201\321\202\321\200\320\260\320\275\320\270\321\206\320\260:", nullptr));
        labelCurrentPage->setText(QApplication::translate("ExistingTables", "1", nullptr));
        label_5->setText(QApplication::translate("ExistingTables", "/", nullptr));
        labelMaxPage->setText(QApplication::translate("ExistingTables", "????", nullptr));
        prevButton->setText(QApplication::translate("ExistingTables", "<<", nullptr));
        label_6->setText(QApplication::translate("ExistingTables", "\320\237\320\265\321\200\320\265\320\271\321\202\320\270 \320\272 \321\201\321\202\321\200\320\260\320\275\320\270\321\206\320\265 \342\204\226:", nullptr));
        nextButton->setText(QApplication::translate("ExistingTables", ">>", nullptr));
