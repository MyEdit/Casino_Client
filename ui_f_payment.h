...
public:
    ...
    void setupUi(QDialog *F_Payment)
    {
        ...
        F_Payment->resize(338, 323);
        verticalLayout = new QVBoxLayout(F_Payment);
        verticalLayout->setObjectName(QString::fromUtf8("verticalLayout"));
        scrollArea = new QScrollArea(F_Payment);
        scrollArea->setObjectName(QString::fromUtf8("scrollArea"));
        scrollArea->setWidgetResizable(true);
        scrollAreaWidgetContents = new QWidget();
        scrollAreaWidgetContents->setObjectName(QString::fromUtf8("scrollAreaWidgetContents"));
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 318, 261));
        ...
        reset = new QPushButton(F_Payment);
...
"}"));
        ...
        applyFilter = new QPushButton(F_Payment);
...
"}"));
    ...
    void retranslateUi(QDialog *F_Payment)
    {
        ...
        label->setText(QApplication::translate("F_Payment", "\320\235\320\260 \321\201\320\276\320\263\320\273\320\260\321\201\320\276\320\262\320\260\320\275\320\270\320\270", nullptr));
        reset->setText(QApplication::translate("F_Payment", "\320\241\320\261\321\200\320\276\321\201\320\270\321\202\321\214", nullptr));
        applyFilter->setText(QApplication::translate("F_Payment", "\320\237\321\200\320\270\320\274\320\265\320\275\320\270\321\202\321\214", nullptr));
    } // retranslateUi
