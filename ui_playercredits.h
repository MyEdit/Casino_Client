...
public:
    ...
    void setupUi(QWidget *PlayerCredits)
    {
        ...
        checkBox_Filtr = new QCheckBox(PlayerCredits);
...
"}"));
    ...
    void retranslateUi(QWidget *PlayerCredits)
    {
        ...
        checkBox_Filtr->setText(QApplication::translate("PlayerCredits", "\320\244\320\270\320\273\321\214\321\202\321\200\320\260\321\206\320\270\321\217", nullptr));
